...
__export(download_exports, {
  download: () => import_chunk_NBFGJS3M.download,
  getBinaryName: () => import_chunk_NBFGJS3M.getBinaryName,
  getVersion: () => import_chunk_NBFGJS3M.getVersion,
  maybeCopyToTmp: () => import_chunk_NBFGJS3M.maybeCopyToTmp,
  plusX: () => import_chunk_NBFGJS3M.plusX,
  vercelPkgPathRegex: () => import_chunk_NBFGJS3M.vercelPkgPathRegex
});
module.exports = __toCommonJS(download_exports);
var import_chunk_NBFGJS3M = require("./chunk-NBFGJS3M.js");
