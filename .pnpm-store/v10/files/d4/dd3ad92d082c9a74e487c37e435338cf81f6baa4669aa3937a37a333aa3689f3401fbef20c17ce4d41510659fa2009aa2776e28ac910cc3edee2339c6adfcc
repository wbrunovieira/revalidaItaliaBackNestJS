...
var chunk_LTPGKJIO_exports = {};
__export(chunk_LTPGKJIO_exports, {
  download: () => download,
...
module.exports = __toCommonJS(chunk_LTPGKJIO_exports);
...
var require_stream = (0, import_chunk_QGM4M3NI.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/stream.js"(exports, module2) {
    "use strict";
    var isStream = (0, import_chunk_H5RYYN3Z.require_is_stream)();
...
var import_temp_dir = (0, import_chunk_QGM4M3NI.__toESM)((0, import_chunk_H5RYYN3Z.require_temp_dir)());
...
async function downloadBinary(options) {
  ...
  const { sha256, zippedSha256 } = await (0, import_chunk_H5RYYN3Z.downloadZip)(downloadUrl, targetFilePath, progressCb);
  if (progressCb) {
    progressCb(1);
  }
