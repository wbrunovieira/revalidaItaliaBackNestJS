...
import { UserAuthorization, UserRole } from '../../enterprise/entities/user-authorization';
...
export abstract class IUserAuthorizationRepository {
   ...
   */
  abstract findById(id: string): Promise<Either<Error, UserAuthorization | null>>;

  /**
   * Find all authorizations by role
   */
  abstract findByRole(role: UserRole): Promise<Either<Error, UserAuthorization[]>>;
