...
describe('AddressController', () => {
  ...
  describe('GET /addresses', () => {
    it('should return 200 [addr1, addr2]', async () => {
      ...
      vi.spyOn(findAddressByUser, 'execute').mockResolvedValueOnce(
        right([addr1, addr2]),
      );
    ...
    it('should return 400 when missing userId', async () => {
      vi.spyOn(findAddressByUser, 'execute').mockResolvedValueOnce(
        left(new InvalidInputError('Missing userId', [])),
      );
    ...
    it('should return 500 on exception thrown', async () => {
      vi.spyOn(findAddressByUser, 'execute').mockImplementationOnce(() => {
  ...
  describe('PATCH /addresses/:id', () => {
    ...
    it('should return 200 with updated address on success', async () => {
      ...
      vi.spyOn(updateAddress, 'execute').mockResolvedValueOnce(right(existing));
    ...
    it('should return 400 on InvalidInputError', async () => {
      ...
      vi.spyOn(updateAddress, 'execute').mockResolvedValueOnce(
